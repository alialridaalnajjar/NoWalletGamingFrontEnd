  ...
  <Header setShowDropList={setShowDropList} showDropList={showDropList}/>
    <div className="min-h-screen bg-neutral-900 text-white pt-10">
      ...
      <div className="bg-gradient-to-r from-neutral-900 to-neutral-800 border-b border-neutral-700">
        <div className="max-w-4xl mx-auto px-4 py-8 lg:py-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl lg:text-4xl font-bold text-white">NWG API</h1>
              <p className="text-neutral-400 text-sm lg:text-base">Simple and fast game data API</p>
            </div>
          </div>
          ...
          <div className="bg-neutral-800/50 border border-neutral-700 rounded-xl p-4 lg:p-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm lg:text-base font-medium">Base URL</span>
            </div>
            <div className="flex items-center justify-between bg-neutral-900 border border-neutral-600 rounded-lg p-3">
              ...
              <button
                onClick={() => copyToClipboard('https://no-wallet-gaming-back-end.vercel.app/', 'base-url')}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 lg:py-12">
          ...
          <div className="bg-neutral-800 border border-neutral-700 rounded-xl p-4 lg:p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              <div className="bg-neutral-900/50 border border-neutral-600 rounded-lg p-4">
                <h3 className="font-semibold text-teal-400 mb-2">No Auth Required</h3>
                <p className="text-sm text-neutral-400">Start using immediately</p>
              </div>
              <div className="bg-neutral-900/50 border border-neutral-600 rounded-lg p-4">
                <h3 className="font-semibold text-teal-400 mb-2">JSON Response</h3>
                <p className="text-sm text-neutral-400">All responses in JSON format</p>
              </div>
              <div className="bg-neutral-900/50 border border-neutral-600 rounded-lg p-4">
                <h3 className="font-semibold text-teal-400 mb-2">CORS Enabled</h3>
                <p className="text-sm text-neutral-400">Use from any domain</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 lg:mb-12">
          ...
          <div className="space-y-6">
            {endpoints.map((endpoint) => (
              <div key={endpoint.id} className="bg-neutral-800 border border-neutral-700 rounded-xl overflow-hidden">
                <div className="bg-neutral-900/50 border-b border-neutral-700 p-4 lg:p-6">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                    ...
                    <button
                      onClick={() => copyToClipboard(`https://no-wallet-gaming-back-end.vercel.app${endpoint.path}`, endpoint.id)}
                      className="flex items-center gap-2 text-neutral-400 hover:text-white transition-colors text-sm"
                    >
                      {copiedEndpoint === endpoint.id ? <Check size={16} /> : <Copy size={16} />}
                      {copiedEndpoint === endpoint.id ? 'Copied!' : 'Copy URL'}
                    </button>
                  </div>  
                ...
                <div className="p-4 lg:p-6">
                  <h4 className="text-sm font-semibold text-neutral-400 mb-3">Response Example:</h4>
        ...
        <section className="mb-8 lg:mb-12">
          <h2 className="text-xl lg:text-2xl font-bold mb-6">Usage Examples</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-neutral-800 border border-neutral-700 rounded-xl p-4 lg:p-6">
              <h3 className="font-semibold text-teal-400 mb-4">JavaScript (Fetch)</h3>
              <div className="bg-neutral-900 border border-neutral-600 rounded-lg p-4 overflow-x-auto">
  ...
  https://no-wallet-gaming-back-end.vercel.app`}
        ...
        <section>
          <div className="bg-gradient-to-r from-teal-500/10 to-neutral-800/50 border border-teal-500/20 rounded-xl p-4 lg:p-6">
            <h3 className="text-lg lg:text-xl font-bold text-white mb-2">Need Help?</h3>
            <p className="text-neutral-300 text-sm lg:text-base mb-4">
